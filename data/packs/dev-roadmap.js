  ...
  "groups": [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "track": "rest",
          "rest": true,
          "reflectPrompt": "Что закрепить из недели?"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "warmup": "Алго-разминка: повторить «Kth Largest» через heap за 8 мин.",
      ...
      "items": [
        {
          ...
          "warmup": "Восстанови по памяти идею двух любых паттернов (например, монотонный стек и бинпоиск по ответу) и где они применимы.",
      ...
      "items": [
        {
          "id": "w13d1",
          "track": "dsa",
          "title": "Повторение паттернов + добивка слабых мест",
          "warmup": "Выпиши 3 решённые ранее задачи, которые давались тяжело; для каждой за 60 сек проговори вслух паттерн и сложность по памяти, не открывая решение.",
          "reflectPrompt": "Какой паттерн всё ещё не «щёлкает» с первого взгляда и что конкретно мешает его опознать в условии?",
          "tasks": [
            {
              "id": "t1",
              "text": "Пере-решить 3-4 пройденные задачи, которые помнишь как «забыл/тормозил». Цель — узнавание паттерна за 30-60 сек, а не код наизусть."
            },
            {
              "id": "t2",
            ...
            {
              "id": "t3",
              "text": "Обновить шпаргалку «триггеры паттернов»: для каждого добитого паттерна записать 1 строку «когда вижу X в условии — беру Y»."
            }
          ],
          "resources": [
            {
